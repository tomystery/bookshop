	...
	<tr valign="top">
		...
		<table width="80%" border="0" align="center" cellpadding="4"
			...
			<tr align="center" bgcolor="#F2FDFF">
				...
				<td align="left"><input type="text" name="addtime"
					style="width: 160px" value="<?php echo $rs->addtime ?>" /></td>
			</tr>
			<?php } ?>
