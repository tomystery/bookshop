	...
	<tr valign="top">
		...
		<table width="96%" border="0" align="center" cellpadding="4"
			...
			<tr align="left" bgcolor="#F2FDFF">
				<td colspan="12" class="optiontitle">图书分类信息列表</td>
			</tr>
			<tr align="center">
			...
			$strAll = "select count(*) as num from cate;";
			...
			$str = "select  a.id as id , a.catename as catename   from cate a  order by id desc limit $offset,$pageSize ;";
			$result = check($str);
			$i=0;
			...
			<tr align="center" bgcolor="#FFFFFF"
				...
				<td align="center"><a href="editcate.php?id=<?php echo $rs->id; ?>">【编辑】</a></td>
			</tr>
			<?php
			$i=$i+1;
			}
			...
			<tr align="right" bgcolor="#F2FDFF">
				<td colspan="12">
				<form action="listcate.php" method="get">共<?php echo $pages ?> 页 (<?php echo  $rowNum ?>
				条记录)&nbsp;&nbsp;&nbsp;<select name="page">
				<?php for($i=1;$i<$pages+1;$i++){ ?>
					<option value="<?php echo $i ?>"><?php echo $i ?></option>
					<?php } ?>
				</select><input type="submit" value="GO" /><a
					href="listcate.php?page=<?php echo $first ?>">第一页</a>&nbsp;&nbsp;&nbsp;<a
					href="listcate.php?page=<?php echo $prev ?>">上一页</a>
				&nbsp;&nbsp;&nbsp;<a href="listcate.php?page=<?php echo $next ?>">下一页</a>
				&nbsp;&nbsp;&nbsp;<a href="listcate.php?page=<?php echo $last ?>">最后一页</a>&nbsp;&nbsp;&nbsp;</form>
				</td>
			</tr>
		</table>
		</td>
