	...
	<tr valign="top">
		...
		<table width="96%" border="0" align="center" cellpadding="4"
			...
			<tr align="left" bgcolor="#F2FDFF">
				<td colspan="12" class="optiontitle">图书评价信息列表</td>
			</tr>
			<tr align="center">
			...
			$strAll = "select count(*) as num from topic;";
			...
			$str = "select  a.* , b.uname , c.name   from topic a , users b , goods c where a.usersid = b.id and a.goodsid = c.id order by id desc limit $offset,$pageSize ;";
			$result = check($str);
			$i=0;
			...
			<tr align="center" bgcolor="#FFFFFF"
				...
				<td align="center"><img src="../img/images/stars<?php echo $rs->num ?>.gif" alt="" /></td>
				<td align="center"><?php echo $rs->contents ;?></td>
				<td align="center"><?php echo $rs->addtime ;?></td>
				<td align="center"><a
					href="topicfunc.php?id=<?php echo $rs->id; ?>&&method=delete"
			...
			<tr align="right" bgcolor="#F2FDFF">
				<td colspan="12">
				<form action="listtopic.php" method="get">共<?php echo $pages ?> 页 (<?php echo  $rowNum ?>
				条记录)&nbsp;&nbsp;&nbsp;<select name="page">
				<?php for($i=1;$i<$pages+1;$i++){ ?>
					<option value="<?php echo $i ?>"><?php echo $i ?></option>
					<?php } ?>
				</select><input type="submit" value="GO" /><a
					href="listtopic.php?page=<?php echo $first ?>">第一页</a>&nbsp;&nbsp;&nbsp;<a
					href="listtopic.php?page=<?php echo $prev ?>">上一页</a>
				&nbsp;&nbsp;&nbsp;<a href="listtopic.php?page=<?php echo $next ?>">下一页</a>
				&nbsp;&nbsp;&nbsp;<a href="listtopic.php?page=<?php echo $last ?>">最后一页</a>&nbsp;&nbsp;&nbsp;</form>
				</td>
			</tr>
		</table>
		</td>
