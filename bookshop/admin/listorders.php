	...
	<tr valign="top">
		...
		<table width="96%" border="0" align="center" cellpadding="4"
			...
			<tr align="left" bgcolor="#F2FDFF">
				<td colspan="12" class="optiontitle">订单信息列表</td>
			</tr>
			<tr align="center">
			...
			$strAll = "select count(*) as num from orders;";
			...
			$str = "select  a.* , b.uname   from orders a , users b where a.usersid = b.id order by id desc limit $offset,$pageSize ;";
			$result = check($str);
			$i=0;
			...
			<tr align="center" bgcolor="#FFFFFF"
				...
				<td align="center"><?php echo $rs->receiver ;?></td>
				<td align="center"><?php echo $rs->contact ;?></td>
				<td align="center"><?php echo $rs->address ;?></td>
				<td align="center">
				<a href="listdetails.php?id=<?php echo $rs->ordercode; ?>">【查看明细】</a>
				<?php if($rs->status == "未发货"){ ?>
						|<a href="ordersfunc.php?id=<?php echo $rs->id; ?>&method=send">【发货】</a>
				<?php } ?>
				<?php if($rs->status == "取消"){ ?>
						|<a href="ordersfunc.php?id=<?php echo $rs->id; ?>&&method=delete"
			...
			<tr align="right" bgcolor="#F2FDFF">
				<td colspan="12">
				<form action="listorders.php" method="get">共<?php echo $pages ?> 页 (<?php echo  $rowNum ?>
				条记录)&nbsp;&nbsp;&nbsp;<select name="page">
				<?php for($i=1;$i<$pages+1;$i++){ ?>
					<option value="<?php echo $i ?>"><?php echo $i ?></option>
					<?php } ?>
				</select><input type="submit" value="GO" /><a
					href="listorders.php?page=<?php echo $first ?>">第一页</a>&nbsp;&nbsp;&nbsp;<a
					href="listorders.php?page=<?php echo $prev ?>">上一页</a>
				&nbsp;&nbsp;&nbsp;<a href="listorders.php?page=<?php echo $next ?>">下一页</a>
				&nbsp;&nbsp;&nbsp;<a href="listorders.php?page=<?php echo $last ?>">最后一页</a>&nbsp;&nbsp;&nbsp;</form>
				</td>
			</tr>
		</table>
		</td>
