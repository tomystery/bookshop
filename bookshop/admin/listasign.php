	...
	<tr valign="top">
		...
		<table width="96%" border="0" align="center" cellpadding="4"
			...
			<tr align="left" bgcolor="#F2FDFF">
				<td colspan="12" class="optiontitle">课程预约信息列表</td>
			</tr>
			<tr align="center">
			...
			$strAll = "select count(*) as num from asign;";
			...
			$str = "select  a.* , b.uname , c.coursename   from asign a , users b , course c where a.usersid = b.id and a.courseid = c.id order by id desc limit $offset,$pageSize ;";
			$result = check($str);
			$i=0;
			...
			<tr align="center" bgcolor="#FFFFFF"
				...
				<td align="center"><a
					href="asignfunc.php?id=<?php echo $rs->id; ?>&&method=delete"
			...
			<tr align="right" bgcolor="#F2FDFF">
				<td colspan="12">
				<form action="listasign.php" method="get">共<?php echo $pages ?> 页 (<?php echo  $rowNum ?>
				条记录)&nbsp;&nbsp;&nbsp;<select name="page">
				<?php for($i=1;$i<$pages+1;$i++){ ?>
					<option value="<?php echo $i ?>"><?php echo $i ?></option>
					<?php } ?>
				</select><input type="submit" value="GO" /><a
					href="listasign.php?page=<?php echo $first ?>">第一页</a>&nbsp;&nbsp;&nbsp;<a
					href="listasign.php?page=<?php echo $prev ?>">上一页</a>
				&nbsp;&nbsp;&nbsp;<a href="listasign.php?page=<?php echo $next ?>">下一页</a>
				&nbsp;&nbsp;&nbsp;<a href="listasign.php?page=<?php echo $last ?>">最后一页</a>&nbsp;&nbsp;&nbsp;</form>
				</td>
			</tr>
		</table>
		</td>
